...
export class AgentService {
  ...
  checkAccount_solde(id_client:any,amount : any) {
    return this._http.get(this.baseUrl+"client/account/"+id_client+"?amount="+amount);
  }

  checkRecipient_infos(infos : any) {
    return this._http.get(this.baseUrl+"client/recipient?lname="+infos.receiver_lname+"&phnumber="+infos.receiver_phnumber);
  }

  sendOtpToClient(otp:any,phn:any) {
    return this._http.post(this.baseUrl+"MultiTransfer/client/otp?otp="+otp+"&phone_number="+phn,{});
  }
